...
/* package Raincat-1.2.1 */
#ifndef VERSION_Raincat
#define VERSION_Raincat "1.2.1"
#endif /* VERSION_Raincat */
#ifndef MIN_VERSION_Raincat
#define MIN_VERSION_Raincat(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  2 || \
  (major1) == 1 && (major2) == 2 && (minor) <= 1)
#endif /* MIN_VERSION_Raincat */
...
/* package sdl2-2.5.3.2 */
#ifndef VERSION_sdl2
#define VERSION_sdl2 "2.5.3.2"
#endif /* VERSION_sdl2 */
...
#define CURRENT_COMPONENT_ID "Raincat-1.2.1-inplace-raincat"
