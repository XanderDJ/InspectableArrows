...
data WorldState = WorldState
    {
        ...
        gameTextures :: M.Map ResourceConfig [Nxt.Types.Texture]
    }
...
loadLevel worldState levelPath = do
    ...
    let lvlData = levelData lvl
        ...
        lvlFireHydrants = map (\fhRect -> initFireHydrantA (gameTextures worldState, (rectX fhRect, rectY fhRect), DirLeft)) lvlFireHydrantsL
         ++ map (\fhRect -> initFireHydrantA (gameTextures worldState, (rectX fhRect, rectY fhRect), DirRight)) lvlFireHydrantsR
        levelend = initEndMarkerA (gameTextures worldState, (rectX lvlEndRect, rectY lvlEndRect))
